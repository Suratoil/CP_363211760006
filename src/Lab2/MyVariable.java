...
public class MyVariable {
    public static void main(String[] args) {
      ...
      int y = 20; // ประกาศตัวแปรชื่อ y และกำหนดค่าให้เท่ากับ 20
        ...
        //charactrer ตัวอักษรเพียง 1 ตัวเท่านั้น เช่น # $ % A a
        char c = 'c';
        ...
        //string เป้นคลาสในภาษา Java ใช้สำหรับเก็บข้อมูลชนิด ข้อความ
        ...
        System.out.println(s.toLowerCase());//แปลงอักขระเป็นพิมพ์เล็ัก
